...
const openDog = (dog_description, target_dog) => {
  target_dog.innerHTML = dog_description;
};
// Eventlisteners for the pictures, and functions that add the text to the document
pic_goldie.addEventListener("click", function() {
  openDog(goldie_text, dog_text);
});

pic_arianna.addEventListener("click", function() {
  openDog(arianna_text, dog_text);
});

pic_whitney.addEventListener("click", function() {
